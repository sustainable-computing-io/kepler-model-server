...
def prepare_profile_path(profile_top_path: pathlib.Path):
    profile_path = profile_top_path / "profile"
            ...
            for node_type in node_types:
                ...
                for component in energy_components:
                    ...
                    if node_type_key not in profile[component]:
                        profile[component][node_type_key] = {min_watt_key: min_watt, max_watt_key: max_watt, unit_num_key: len(related_labels)}
                    else:
