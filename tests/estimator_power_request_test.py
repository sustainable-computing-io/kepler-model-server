...
from train_types import CATEGORICAL_LABEL_TO_VOCAB, SYSTEM_FEATURES, WORKLOAD_FEATURES, ModelOutputType, PowerSourceMap
...
def generate_request(
    train_name,
    n=1,
    metrics=WORKLOAD_FEATURES,
    system_features=SYSTEM_FEATURES,
    output_type=ModelOutputType.DynPower.name,
