...
from isolator_test import get_isolate_results, test_isolators
...
def process(
    ...
    for trainer_name in trainer_names:
        ...
        trainer = trainer_class(
            energy_components, feature_group, energy_source, node_level=node_level, pipeline_name=pipeline_name
        )
...
if __name__ == "__main__":
    ...
    print(
        dyn_train_df.set_index(["extractor", "isolator", "feature_group"])[focus_columns].sort_values(
