...
if __name__ == "__main__":
    ...
    extracted_data, power_columns, _, _ = instance.extract(
    ...
    xgb_node_pipeline_kfold = XGBoostRegressionStandalonePipeline(
        XGBoostRegressionTrainType.KFoldCrossValidation, "test_models/XGBoost/", node_level=False
    )
    ...
    xgb_node_pipeline_tts = XGBoostRegressionStandalonePipeline(
        XGBoostRegressionTrainType.TrainTestSplitFit, "test_models/XGBoost/", node_level=True
    )
